...
In this project I created a Snake AI that implemented the BFS and A* algorithm to find the shortest path from the head of the Snake to the apple using Java on Eclipse
